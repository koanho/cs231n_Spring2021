...
def affine_batch_relu_forward(x, w, b, gamma, beta, bn_param):
  a, fc_cache = affine_forward(x, w, b)
  out, bc_cache = batchnorm_forward(a, gamma, beta, bn_param)
  out, relu_cache = relu_forward(out)

  cache = (fc_cache, bc_cache, relu_cache)

  return out, cache

def affine_batch_relu_backward(dout, cache):
  fc_cache, bc_cache, relu_cache = cache

  dout = relu_backward(dout, relu_cache)
  dout, dgamma, dbeta = batchnorm_backward_alt(dout, bc_cache)
...
def affine_batch_relu_dropout_forward(x, w, b, gamma, beta, bn_param, dropout_param):
  ...
  cache = (fc_cache, bc_cache, relu_cache, drop_cache)

  return out, cache

def affine_batch_relu_dropout_backward(dout, cache):
  fc_cache, bc_cache, relu_cache, drop_cache = cache
